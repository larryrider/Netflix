        ...
        <div lang="es-ES" dir="ltr" class="lang_es">
            <div class="bd dark-background has-uma lang_es" lang="es-ES">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <li class="sub-menu-item"><a class="current active" href="/admin" style="cursor:pointer;text-decoration:none;">Admin</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin" style="cursor:pointer;text-decoration:none;">Admin</a></li>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:850px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Opciones de administración</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content">
                                    ...
                                    <h2 class="account-header">Series</h2>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/newCategory">Añadir categoría</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/editCategory">Editar categoría</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/deleteCategory">Eliminar categoría</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/newSerie">Añadir serie</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/editSerie">Editar serie</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/deleteSerie">Eliminar serie</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/newSeason">Añadir temporada</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/editChapter">Editar capítulo</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/deleteSeason">Eliminar temporada</a>

                                    <h2 class="account-header">Directores</h2>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/newDirector">Añadir Director</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/editDirector">Editar Director</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/deleteDirector">Eliminar Director</a>

                                    <h2 class="account-header">Actores</h2>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/newActor">Añadir Actor</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/editActor">Editar Actor</a>
                                    <a class="btn hero-cta-btn btn-large btn-red" role="link" style="min-width:256px;" href="/admin/deleteActor">Eliminar Actor</a>
                                </section>
                                </div>
                                </br>
                                    </br></br>
