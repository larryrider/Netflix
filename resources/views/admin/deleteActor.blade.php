                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/deleteActor" style="cursor:pointer;text-decoration:none;">Eliminar Actor</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/deleteActor" style="cursor:pointer;text-decoration:none;">Eliminar Actor</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Eliminar Actor</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('ActorController@delete')}}" method="POST">
                                        {{method_field('DELETE')}}
                                        {{ csrf_field() }}
                                        <label>
                                            <span class="ui-label-text">Actores</span>
                                            <input type="hidden" id="actor" name="actor"></input>
                                            <select data-placeholder="Seleccione un actor" class="chosen-select" name="selectactor" style="min-width: 187px;">
                                                <option></option>
                                                @foreach($actors as $d)
        ...
        (function() {
            $(document).on('change', 'select', function() {
                $( "select option:selected" ).each(function() {
                    ...
                    document.getElementById("desc").innerHTML = 'Has seleccionado a ' + t.bold() + ' ¿Quieres borrarlo?'; 
                    document.getElementById("btn").style.display="block";
                    document.getElementById("btn2").style.display="block";
                    document.getElementById("actor").innerHTML = $( this ).attr('id');
                    document.getElementById("actor").value = $( this ).attr('id');
                });
            });
        })();
    </script>
