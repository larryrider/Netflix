                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/deleteDirector" style="cursor:pointer;text-decoration:none;">Eliminar Director</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Eliminar Director</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('DirectorController@delete')}}" method="POST">
                                        {{method_field('DELETE')}}
                                        {{ csrf_field() }}
                                        <label>
                                            <span class="ui-label-text">Directores</span>
                                            <input type="hidden" id="director" name="director"></input>
                                            <select data-placeholder="Seleccione un director" class="chosen-select" name="selectdirector" style="min-width: 187px;">
                                                <option></option>
        ...
        (function() {
            $(document).on('change', 'select', function() {
                $( "select option:selected" ).each(function() {
                    ...
                    document.getElementById("director").innerHTML = $( this ).attr('id');
                    document.getElementById("director").value = $( this ).attr('id');
                });
            });
        })();
    </script>
