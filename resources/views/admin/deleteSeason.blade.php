                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/deleteSeason" style="cursor:pointer;text-decoration:none;">Eliminar temporada</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/deleteSeason" style="cursor:pointer;text-decoration:none;">Eliminar temporada</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Eliminar serie</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('SerieController@deleteLastSeason')}}" method="POST">
                                        {{method_field('DELETE')}}
                                        {{ csrf_field() }}
                                        <label>
                                        ...
                                        <div style="margin-left: 120px; ">
                                            ...
                                            <button id="btn2" onclick="location.reload()" style="display: none;" class="btn hero-cta-btn btn-large btn-red" autocomplete="off" tabindex="4">
                                                No
                                            </button>
                                        </div>
                                    </form>
        ...
        (function() {
            $(document).on('change', 'select', function() {
                $( "select option:selected" ).each(function() {
                    ...
                    document.getElementById("desc").innerHTML = 'Has seleccionado la serie ' + t.bold() +' que tiene '+s.bold()+ ' temporadas ¿Quieres borrar la ultima temporada?'; 
