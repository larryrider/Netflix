                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/editActor" style="cursor:pointer;text-decoration:none;">Editar Actor</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/editActor" style="cursor:pointer;text-decoration:none;">Editar Actor</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Editar Actor</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('ActorController@edit')}}" method="POST">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="PUT"></input>
                                        <input type="hidden" name="id" id="id"></input>
                                        <label>
                                            <span class="ui-label-text">Actores</span>
                                            <select data-placeholder="Seleccione un actor" class="chosen-select" name="actors" style="min-width: 187px;">
                                                <option></option>
                                                @foreach($actors as $a)
                                                <option id="{{$a->id}}" name="{{$a->name}}">{{$a->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <label>
                                            <span class="ui-label-text">Nombre actor</span>
