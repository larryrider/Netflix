...
<body>
                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/editChapter" style="cursor:pointer;text-decoration:none;">Editar capítulo</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/editChapter" style="cursor:pointer;text-decoration:none;">Editar capítulo</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Editar capítulo</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <input id="chapters" type="hidden" style="display: none;" value="{{$chapters}}"></input>
                                    <form action="{{action('SerieController@editChapter')}}" method="POST">
                                        {{method_field('PUT')}}
                                        {{ csrf_field() }}
                                        <label id="labelSeries">
                                            <span class="ui-label-text">Series</span>
                                            <input type="hidden" id="serie" name="serie"></input>
                                            <select id="selectSeries" data-placeholder="Seleccione una serie" class="chosen-select" name="series" style="min-width: 187px;">
                                                <option></option>
                                                @foreach($series as $s)
                                                <option id="{{$s->id}}" name="{{$s->id}}" title="{{$s->title}}" seasons="{{$s->seasons}}">{{$s->title}}</option>
                                                @endforeach
                                            </select>
                                        </label>
                                        </br>
                                        </br>
                                        <label id="labelChapter">
                                            <span class="ui-label-text">Selecciona un capítulo</span>
                                            <input type="hidden" id="seasons" name="seasons" value=""></input>
                                            <select id="selectChapter"data-placeholder="Seleccione un capítulo" class="chosen-select" name="seasons" style="min-width: 187px;">
                                                
                                            </select>
                                            <input type="hidden" id="inputsChapters" name="inputsChapters" value=""></input>
                                        </label>
                                        </br>
                                        </br>
                                        
                                        <label>
                                            <span class="ui-label-text">Titulo </span>
                                            <input type="text" id="titleChapter" name="titleChapter" value="" required></input>
                                        ...
                                        <label>
                                            ...
                                            <input type="text" id="descChapter" name="descChapter" value="" required></input>
                                        </label>
                                        </br>
                                        </br>
    ...
    <script>
        (function() {
            document.getElementById("titleChapter").readOnly = true;
            document.getElementById("descChapter").readOnly = true;
            $('#selectChapter').attr("disabled", true).trigger("chosen:updated");
            $(document).on('change', '#selectSeries', function() {
                document.getElementById("titleChapter").readOnly = false;
                document.getElementById("descChapter").readOnly = false;
                $('#selectChapter').attr("disabled", false).trigger("chosen:updated");
                $( "#labelSeries > select option:selected" ).each(function() {
                    $('#selectChapter').val('').trigger('chosen:updated');
                    $('#selectChapter').empty();
                    var id = $(this).attr('id');

                    var chapters = JSON.parse(document.getElementById("chapters").value);
                    ...
                    chapters.forEach(function(c){
                        if(c.serie_id == id){
                            ...
                            option.setAttribute('title',c.title);
                            option.setAttribute('desc',c.description);
                            option.text = "Temp. "+c.season + " - " + c.title;
                            select.add(option);
                        }
                        
                    });
                    $('#selectChapter').trigger('chosen:updated');
                    $('#selectChapter').trigger('change');
                    document.getElementById("serie").innerHTML = $( this ).attr('id');
                    document.getElementById("serie").value = $( this ).attr('id');
                });
            });
            ...
            $(document).on('change', '#selectChapter', function() {
                ...
                $( "#labelChapter > select option:selected" ).each(function() {
                    var id = $(this).attr('id');
                    var title = $(this).attr('title');
                    var desc = $(this).attr('desc');

                    document.getElementById("titleChapter").value = title;
                    document.getElementById("descChapter").value = desc;
                ...
                $( "#inputsChapters" ).empty();
                $( "#inputsChapters" ).append( selecteds );
            })();
        })();
    </script>
</body>
