                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/editSerie" style="cursor:pointer;text-decoration:none;">Editar Serie</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/editSerie" style="cursor:pointer;text-decoration:none;">Editar Serie</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Editar Serie</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('SerieController@edit')}}" method="POST">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="PUT"></input>
                                        <input type="hidden" name="idSerie" id="idSerie" value=""></input>
                                        <input type="hidden" name="selectedCategories" id="selectedCategories" value="{{$selectedCategories}}"></input>
                                        <input type="hidden" name="selectedActors" id="selectedActors" value="{{$selectedActors}}"></input>
                                        <input type="hidden" name="selectedDirectors" id="selectedDirectors" value="{{$selectedDirectors}}"></input>
                                        <label id="labelSeries">
                                            <span class="ui-label-text">Series</span>
                                            <select id="selectSeries" data-placeholder="Seleccione una serie" class="chosen-select" name="series" style="min-width: 187px;">
                                                <option></option>
                                                @foreach($series as $s)
                                                <option id="{{$s->id}}" name="{{$s->id}}" serie="{{$s}}">{{$s->title}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <label>
                                            <span class="ui-label-text">Titulo serie</span>
                                            <input class="ui-text-input" type="text" name="title" id="title" value="" tabindex="1" required autofocus/>
                                            @if ($errors->has('title'))
                                        ...
                                        <label>
                                            <span class="ui-label-text">Año</span>
                                            <input class="ui-text-input" type="number" name="year" id="year" value="" tabindex="1" required autofocus/>
                                            @if ($errors->has('year'))
                                                <span class="help-block">
                                        ...
                                        <label>
                                            <span class="ui-label-text">Descripción</span>
                                            <input type="text" class="ui-text-input" name="description" id="description" tabindex="2" required/>
                                        ...
                                        <label>
                                            <span class="ui-label-text">Edad recomendada</span>
                                            <input type="number" class="ui-text-input" name="rating_age" id="rating_age" tabindex="2" required/>
                                            @if ($errors->has('rating_age'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('rating_age') }}</strong>
                                                </span>
                                            @endif
                                        </label>
                                        </br>
                                        ...
                                        <label>
                                            <span class="ui-label-text">Enlace Imagen</span>
                                            <input type="text" class="ui-text-input" name="image" id="image" tabindex="2" required/>
                                            @if ($errors->has('image'))
                                                <span class="help-block">
                                        ...
                                        <label>
                                            <span class="ui-label-text">Enlace preview</span>
                                            <input type="text" class="ui-text-input" name="image_preview" id="image_preview" tabindex="2" required/>
                                            @if ($errors->has('image_preview'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('image_preview') }}</strong>
                                                </span>
                                            @endif
                                        </label>
                                        </br>
                                        </br>
                                        <label id="labelCategories">
                                            <span class="ui-label-text">Categorías</span>
                                            <select id="selectCategories" data-placeholder="Seleccione una categoría" multiple class="chosen-select" name="selectCategories" style="min-width: 187px;" required>
                                                @foreach($categories as $c)
                                                <option id="{{$c->id}}" name="{{$c->id}}" value="{{$c->category}}">{{$c->category}}</option>
                                                @endforeach
                                            </select>
                                            <div id="inputsCategory" name="inputsCategory"></div>
                                        </label>
                                        </br>
                                        <label id="labelActors">
                                            <span class="ui-label-text">Actores</span>
                                            <select id="selectActors" data-placeholder="Seleccione los actores" multiple class="chosen-select" name="selectActors" style="min-width: 187px;" required>
                                                @foreach($actors as $c)
                                                <option id="{{$c->id}}" name="{{$c->id}}" value="{{$c->name}}">{{$c->name}}</option>
                                                @endforeach
                                            </select>
                                            <div id="inputsActors" name="inputsActors"></div>
                                        </label>
                                        </br>
                                        <label id="labelDirectors">
                                            <span class="ui-label-text">Director</span>
                                            <select id="selectDirectors" data-placeholder="Seleccione el director" class="chosen-select" name="selectDirectors" style="min-width: 187px;" required>
                                                <option></option>
                                                @foreach($directors as $c)
                                                <option id="{{$c->id}}" name="{{$c->id}}" value="{{$c->name}}">{{$c->name}}</option>
                                                @endforeach
                                            </select>
                                            <div id="inputsDirectors" name="inputsDirectors"></div>
                                        </label>
                                        </br>
                                        </br>
    ...
    <script>
        (function() {
            if(document.getElementById("idSerie").value == ""){
                ...
                document.getElementById("image_preview").readOnly = true;
                document.getElementById("year").readOnly = true;
                document.getElementById("rating_age").readOnly = true;
                $('#selectCategories').attr("disabled", true).trigger("chosen:updated");
                $('#selectActors').attr("disabled", true).trigger("chosen:updated");
                $('#selectDirectors').attr("disabled", true).trigger("chosen:updated");
            }
            var selectedCategories = JSON.parse(document.getElementById("selectedCategories").value);
            var selectedActors = JSON.parse(document.getElementById("selectedActors").value);
            var selectedDirectors = JSON.parse(document.getElementById("selectedDirectors").value);
            $(document).on('change', '#selectSeries', function() {
                document.getElementById("title").readOnly = false;
                document.getElementById("description").readOnly = false;
                document.getElementById("image").readOnly = false;
                document.getElementById("image_preview").readOnly = false;
                document.getElementById("year").readOnly = false;
                document.getElementById("rating_age").readOnly = false;
                $('#selectCategories').attr("disabled", false).trigger("chosen:updated");
                $('#selectActors').attr("disabled", false).trigger("chosen:updated");
                $('#selectDirectors').attr("disabled", false).trigger("chosen:updated");

                document.getElementById("idSerie").value = "";
                document.getElementById("title").value = "";
                document.getElementById("description").value = "";
                document.getElementById("image").value = "";
                document.getElementById("image_preview").value = "";
                document.getElementById("year").value = "";
                document.getElementById("rating_age").value = "";
                $('#selectCategories').val('').trigger('chosen:updated');
                $('#selectCategories').trigger('change');
                $('#selectActors').val('').trigger('chosen:updated');
                $('#selectActors').trigger('change');
                $('#selectDirectors').val('').trigger('chosen:updated');
                $('#selectDirectors').trigger('change');

                $( "#labelSeries > select option:selected" ).each(function() {
                    document.getElementById("idSerie").value = JSON.parse($( this ).attr('serie')).id;
                    document.getElementById("title").value = JSON.parse($( this ).attr('serie')).title;
                    document.getElementById("description").value = JSON.parse($( this ).attr('serie')).description;
                    document.getElementById("image").value = JSON.parse($( this ).attr('serie')).image;
                    document.getElementById("image_preview").value = JSON.parse($( this ).attr('serie')).image_preview;
                    document.getElementById("year").value = JSON.parse($( this ).attr('serie')).year;
                    document.getElementById("rating_age").value = JSON.parse($( this ).attr('serie')).rating_age;
                    for(i=0; i<selectedCategories.length; i++){
                        if(selectedCategories[i][0] == document.getElementById("idSerie").value){
                            var serieCategories = JSON.parse(selectedCategories[i][1]);
                            var arrayCategories = [];
                            for(j=0; j<serieCategories.length; j++){
                                arrayCategories = arrayCategories.concat(serieCategories[j].category);
                            }
                            $('#selectCategories').val(arrayCategories).trigger('chosen:updated');
                            $('#selectCategories').trigger('change');
                        }
                    }
                    for(i=0; i<selectedActors.length; i++){
                        if(selectedActors[i][0] == document.getElementById("idSerie").value){
                            var serieActors = JSON.parse(selectedActors[i][1]);
                            var arrayActors = [];
                            for(j=0; j<serieActors.length; j++){
                                arrayActors = arrayActors.concat(serieActors[j].name);
                            }
                            $('#selectActors').val(arrayActors).trigger('chosen:updated');
                            $('#selectActors').trigger('change');
                        }
                    }
                    for(i=0; i<selectedDirectors.length; i++){
                        if(selectedDirectors[i][0] == document.getElementById("idSerie").value){
                            var serieDirectors = JSON.parse(selectedDirectors[i][1]);
                            $('#selectDirectors').val(serieDirectors[0].name).trigger('chosen:updated');
                            $('#selectDirectors').trigger('change');
                        }
                    }
                });
            });
            $(document).on('change', '#selectCategories', function() {
                var selecteds = "";
                $( "#labelCategories > select option:selected" ).each(function() {
                    selecteds += "<input style=\"display:none\" " + 
                        "id=\"" + $( this ).attr('id') + 
                        "\" name=\"categories[]" + 
                        "\" value=\"" + $( this ).attr('id') + "\" </input>";
                });
                $( "#inputsCategory" ).empty();
                $( "#inputsCategory" ).append( selecteds );
            });
            $(document).on('change', '#selectActors', function() {
                var selecteds = "";
                $( "#labelActors > select option:selected" ).each(function() {
                    selecteds += "<input style=\"display:none\" " + 
                        "id=\"" + $( this ).attr('id') + 
                        "\" name=\"actors[]" + 
                        "\" value=\"" + $( this ).attr('id') + "\" </input>";
                ...
                $( "#inputsActors" ).empty();
                $( "#inputsActors" ).append( selecteds );
            });
            $(document).on('change', '#selectDirectors', function() {
                var selecteds = "";
                $( "#labelDirectors > select option:selected" ).each(function() {
                    selecteds += "<input style=\"display:none\" " + 
                        "id=\"" + $( this ).attr('id') + 
                        "\" name=\"directors[]" + 
                        "\" value=\"" + $( this ).attr('id') + "\" </input>";
                });
                $( "#inputsDirectors" ).empty();
                $( "#inputsDirectors" ).append( selecteds );
            });
        })();
    </script>
</body>
