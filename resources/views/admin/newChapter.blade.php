                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Añadir capitulo</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('ChapterController@create')}}" method="POST">
                                        {{ csrf_field() }}
                                    
                                            <h1 class="account-header" data-reactid="75">Capitulo {{session()->get('cuenta')}} de {{session()->get('chapters')}}</h1>
                                            </br>
                                            <label>
                                                <span class="ui-label-text">Titulo capitulo</span>
                                                <input class="ui-text-input" type="text" name="title" id="title" tabindex="1" required autofocus/>
                                                @if ($errors->has('title'))
