                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <li class="sub-menu-item"><a class="current active" href="/admin/newDirector" style="cursor:pointer;text-decoration:none;">Añadir Director</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/newDirector" style="cursor:pointer;text-decoration:none;">Añadir Director</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Nuevo Director</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('DirectorController@create')}}" method="POST">
                                        {{ csrf_field() }}
                                        <label>
                                            <span class="ui-label-text">Nombre</span>
                                            <input class="ui-text-input" type="text" placeholder="Introduzca nombre director" name="name" id="name" value="" tabindex="1" required autofocus/>
                                            @if ($errors->has('name'))
