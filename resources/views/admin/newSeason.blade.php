                ...
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/admin/newSeason" style="cursor:pointer;text-decoration:none;">Añadir temporada</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/newSeason" style="cursor:pointer;text-decoration:none;">Añadir temporada</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Añadir temporada</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:210px;">
                                    </br>
                                    <form action="{{action('SerieController@addSeason')}}" method="POST">
                                        {{method_field('PUT')}}
                                        {{ csrf_field() }}
                                        <label>
                                            <span class="ui-label-text">Series</span>
                                            <input type="hidden" id="serie" name="serie"></input>
                                            <select data-placeholder="Seleccione una serie" class="chosen-select" name="series" style="min-width: 187px;">
                                                <option></option>
                                                @foreach($series as $s)
                                        ...
                                        <label id="chap" style="display: none;">
                                            <span class="ui-label-text" style="display:inline-block"><strong>Numero de capitulos nueva temporada:</strong></span>
                                            <input type="number" class="ui-text-input" style="max-width:75px;" name="chapters" id="chapters" tabindex="2" required/>
                                        ...
                                        <div style="margin-left: 85px;">
                                            <button id="btn" style="display:none;" class="btn hero-cta-btn btn-large btn-red" type="submit" autocomplete="off" tabindex="4">
                                                Añadir temporada
                                            </button>
                                        </div>
                                    </form>
        ...
        (function() {
            $(document).on('change', 'select', function() {
                $( "select option:selected" ).each(function() {
                    ...
                    var s = $( this ).attr('seasons');

                    document.getElementById("desc").innerHTML = 'La serie ' + t.bold() + ' tiene ' + s.bold() + ' temporadas'; 
                    document.getElementById("btn").style.display="block";
                    document.getElementById("chap").style.display="block";
