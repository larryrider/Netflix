                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <li class="sub-menu-item"><a class="current active" href="/admin/newSerie" style="cursor:pointer;text-decoration:none;">Añadir Serie</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/admin/newSerie" style="cursor:pointer;text-decoration:none;">Añadir Serie</a>
                            </li>
                        </ul>
                ...
                <div class="mainView" role="main" style="min-height:400px;">
                    <div class="responsive-account-container" style="min-width:80px;width:800px;margin:0 auto;padding:30px;">
                        <div style="text-align:center;">
                            <h1 class="account-header">Nueva Serie</h1>
                            <div class="responsive-account-content">
                                ...
                                <section class="collapsable-section-content account-section-content" style="text-align:left;margin-left:200px;">
                                    ...
                                    <form action="{{action('SerieController@create')}}" method="POST">
                                        {{ csrf_field() }}
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Titulo serie</span>
                                            <input class="ui-text-input" placeholder="Introduzca titulo" type="text" name="title" id="title" value="" tabindex="1" required/>
                                            @if ($errors->has('title'))
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Año</span>
                                            <input class="ui-text-input" placeholder="Introduzca año" type="number" name="year" id="year" value="" tabindex="1" required/>
                                            @if ($errors->has('year'))
                                                <span class="help-block">
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Descripción</span>
                                            <input type="text" class="ui-text-input" placeholder="Introduzca descripcion" name="description" id="description" tabindex="2" required/>
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Edad recomendada</span>
                                            <input type="number" class="ui-text-input" placeholder="Introduzca edad" name="rating_age" id="rating_age" tabindex="2" required/>
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Enlace imagen</span>
                                            <input type="text" class="ui-text-input" placeholder="Introduzca url de imagen" name="image" id="image" tabindex="2" required/>
                                            @if ($errors->has('image'))
                                                <span class="help-block">
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Enlace imagen (preview)</span>
                                            <input type="text" class="ui-text-input" placeholder="Introduzca url de imagen" name="image_preview" id="image_preview" tabindex="2" required/>
                                        ...
                                        <label id="labelCategories">
                                            <span class="ui-label-text" style="min-width:220px;">Categorías</span>
                                        ...
                                        <label id="labelActors">
                                            <span class="ui-label-text" style="min-width:220px;">Actores</span>
                                        ...
                                        <label id="labelDirectors">
                                            <span class="ui-label-text" style="min-width:220px;">Director</span>
                                        ...
                                        <label>
                                            <span class="ui-label-text" style="min-width:220px;">Capítulos primera temporada</span>
                                            <input class="ui-text-input" type="number" placeholder="Introduzca capitulos" name="chapters" id="chapters" value="" tabindex="1" required/>
                                            @if ($errors->has('chapters'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('chapters') }}</strong>
                                                </span>
                                            @endif
                                        </label>
                                        </br>
