...
<body>
    <div id="appMountPoint">
        <div lang="es-ES" dir="ltr" class="lang_es">
            <div class="bd dark-background has-uma lang_es" lang="es-ES">
                <div class="pinning-header" style="position:absolute;z-index:999;width:100%;">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/serie/{{$serie->id}}/chapters/1">Episodios</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/serie/{{$serie->id}}/chapters/1">Episodios</a>
                            </li>
                        </ul>
                ...
                @if($serie->categories->contains('category','Originales de Netflix'))
					<div class="jawBoneContainer slider-hover-trigger-layer" tabindex="0" style="min-height: 830px;">
                @else
                ...
                @endif
						...
						<div class="jawBone">
							...
							<div class="jawBoneCommon">
                                ...
                                <div class="jawBonePane" id="pane-Episodes" tabindex="-1" style="opacity: 1;">
                                <div class="ptrack-container">
                                   <div class="episodesContainer">
                                        <div class="ptrack-content">
                                            <div class="nfDropDown widthRestricted theme-lakira">
                                                <div id="dropdownTemp" class="label" role="button" tabindex="0" aria-haspopup="true" aria-expanded="true">
                                                    <a class="sub-menu-link" role="link" tabindex="0" style="color: white;">Temporada {{$temp}}</a>
                                                    <span class="arrow"></span>
                                                </div>
                                            </div>
                                            <div id="menuTemp" class="sub-menu theme-lakira" style="opacity: 0;display:none;z-index:1; left: -5px;z-index: 999;">
                                                <ul class="sub-menu-list">
                                                    @for($i=1;$i<=$serie->seasons;$i++)
                                                        <li class="sub-menu-item"><a href="/serie/{{$serie->id}}/chapters/{{$i}}" class="sub-menu-link" role="link" tabindex="0">Temporada {{$i}}</a></li>
                                                    @endfor
                                                </ul>
                                            </div>
                                            <div id="wrapper" class="ease3" >
                                                <div id="vs-netflix-slide-loader" class="drop-loading"><label class="net-loader"></label></div>
                                                <div id="video-list-container" class="ease5 home-video-list" style="background:unset;">
                                                    <div class="video-category slide-category slide-container">
                                                        <div class="video-list-slider" data-items="2">
                                                            @foreach($chapters as $c)
                                                            <a class="video-slide" href="#">
                                                                @if(!$serie->categories->contains('category','Originales de Netflix'))
                                                                <span style="position: relative;top: 130px;left: 5px;color: white;">{{$loop->iteration}}</span>
                                                                @else
                                                                <span style="position: relative;top: 460px;left: 10px;color: white;">{{$loop->iteration}}</span>
                                                                @endif
                                                                <img src="{{$serie->image_preview}}" />
                                                                <div class="video-slide-details border-box">
                                                                    <h4>{{$c->title}}</h4>
                                                                    <p class="slide-text">{{$c->description}} - Temporada {{$c->season}}</p>
                                                                </div>
                                                            </a>
                                                            @endforeach
                                                        </div>
						...
						<ul class="menu" role="tablist">
                            ...
                            <li class="Episodes current" id="tab-Episodes">
	...
	<script>
        (function() {
            ...
            $("#dropdownTemp").click(function(){
                if($("#menuTemp").css('opacity') == '1'){
                    $("#menuTemp").css('opacity', '0');
                    $("#menuTemp").css('display', 'none');
                }
                else{
                    $("#menuTemp").css('opacity', '1');
                    $("#menuTemp").css('display', 'unset');
                }
            });
