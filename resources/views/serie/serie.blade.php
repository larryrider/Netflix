                ...
                <div class="pinning-header" style="position:absolute;z-index:999;width:100%;">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/serie/{{$serie->id}}">{{$serie->title}}</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/serie/{{$serie->id}}">{{$serie->title}}</a>
                            </li>
                        </ul>
					...
					<div class="jawBoneContainer slider-hover-trigger-layer" tabindex="0">
						<div class="background">
							<div class="image-rotator jawBoneBackground">
								<span>
									<div class="image-rotator-image " style="background-image: url({{$serie->image}}); z-index: 2; opacity: 1; transition-duration: 750ms;"></div>
									<div class="image-rotator-image js-transition-node" style="background-image: url({{$serie->image}}); z-index: 1; opacity: 0; transition-duration: 750ms;"></div>
								</span>
							</div>
						...
						<div class="jawBone">
							...
							<a tabindex="0" role="link" aria-label="Reproducir" class="overviewPlay playLink" href="#"
							...
							<div class="jawBoneCommon">
								<div class="jawBonePanes fullBleed">
									<div class="jawBonePane" id="pane-Overview" tabindex="-1" style="opacity: 1; transition-duration: 300ms;">
										<div class="ptrack-container">
											<div>
												<div class="overview">
													<div class="ptrack-content">
														<div class="jawbone-overview-info has-jawbone-nav-transition" style="transform: translateX(0px); opacity: 1; transition-delay: 250ms; transition-duration: 500ms;">
															<div class="meta">
																	...
																	<div class="show-match-score rating-inner">
																		<div class="meta-thumb-container thumb-down">
																			<svg class="svg-icon svg-icon-thumb-down-filled thumb thumb-down-filled" focusable="true">
																				<use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#thumb-down-filled"></use>
																			</svg>
																		</div>
																		<div class="meta-thumb-container thumb-up">
																			<svg class="svg-icon svg-icon-thumb-up-filled thumb thumb-up-filled" focusable="true">
																				<use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#thumb-up-filled"></use>
																			</svg>
																		</div>
																		<span class="match-score">98 % de coincidencia</span>
																	</div>
																</span>
																<span class="year">{{$serie->year}}</span>
																<span class="maturity-rating">
																	<span class="maturity-number">{{$serie->rating_age}}</span>
																</span>
																<span class="duration">
																@if($serie->seasons == 1)
																	1 temporada
															...
															<span>
																<div class="synopsis">{{$serie->description}}</div>
																<div class="listMeta">
																	<p>
																		...
																		<span class="metaList">
																			@foreach($actors as $a)
                                                                                @if(!$loop->last)
																			    <a href="/series/act/{{$a->id}}">{{$a->name}},</a>
                                                                                @else
                                                                                <a href="/series/act/{{$a->id}}">{{$a->name}}.</a>
                                                                                @endif
																			@endforeach
																	...
																	<p>
																		...
																		<span class="metaList">
																			<a href="/series/dir/{{$director->id}}">{{$director->name}}.</a>
																		</span>
																	</p>
																	<p>
																		Géneros:
																		<span class="metaList">
																			@foreach($categories as $cat)
                                                                                @if(!$loop->last)
																			    <a href="/series/cat/{{$cat->id}}">{{$cat->category}}</a>, 
                                                                                @else
                                                                                <a href="/series/cat/{{$cat->id}}">{{$cat->category}}</a>.
                                                                                @endif
																			@endforeach
															...
															<div class="actionsRow" style="display:none">
																<div class="myListWrapper">
																	<div class="nf-svg-button-wrapper mylist-button">
																		<a role="link" tabindex="0" class="nf-svg-button simpleround">
																			<svg class="svg-icon svg-icon-mylist-added" focusable="true">
																				<use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mylist-added"></use>
																			</svg>
																		</a>
																		<span class="nf-svg-button-label" role="status" aria-live="assertive">Mi lista</span>
																	</div>
																</div>
																<div class="thumbs-overview-wrapper">
																	<div class="thumbs-component thumbs thumbs-horizontal animated unrated">
																		<div class="nf-svg-button-wrapper thumb-container thumb-up-container ">
																			<a role="link" data-rating="2" tabindex="0" class="nf-svg-button simpleround">
																				<svg data-rating="2" class="svg-icon svg-icon-thumb-up" focusable="true">
																					<use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#thumb-up"></use>
																				</svg>
																			</a>
																		</div>
																		<div class="nf-svg-button-wrapper thumb-container thumb-down-container ">
																			<a role="link" data-rating="1" tabindex="0" class="nf-svg-button simpleround">
																				<svg data-rating="1" class="svg-icon svg-icon-thumb-down" focusable="true">
																					<use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#thumb-down"></use>
																				</svg>
																			</a>
																		</div>
																	</div>
							...
							<ul class="menu" role="tablist">
								<li class="Overview current" id="tab-Overview">
								...
								<li class="ShowDetails" id="tab-ShowDetails">
									<a href="/serie/{{$serie->id}}/details" role="link" tabindex="0">Detalles</a>
									<span></span>
								</li>
							</ul>
						</div>
