                ...
                <div class="pinning-header" style="position:absolute;z-index:999;width:100%;">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/serie/{{$serie->id}}/similar">Similares</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/serie/{{$serie->id}}/similar">Similares</a>
                            </li>
                        </ul>
                ...
                @endif
						...
						<div class="jawBone">
							...
							<div class="jawBoneCommon">
                                ...
                                <div class="jawBonePane" id="pane-Episodes" tabindex="-1" style="opacity: 1; transition-duration: 300ms;">
                                <div class="ptrack-container">
                                   <div class="episodesContainer">
                                      <div class="ptrack-content" data-ui-tracking-context="%7B%22uuid%22:%22659dc640-9111-4572-9b30-70b9b26cd478%22,%22appView%22:%22jawboneEpisodes%22%7D" data-tracking-uuid="659dc640-9111-4572-9b30-70b9b26cd478">
                                            ...
                                            <div id="video-list-container" class="ease5 home-video-list" style="background:unset;">
                                                <div class="video-category slide-category slide-container">
                                                    <div class="video-list-slider" data-items="2">
                                                        ...
                                                        <a class="video-slide" href="/serie/{{$c->id}}">
                                                            <img src="{{$c->image_preview}}" />
                                                            <div class="video-slide-details border-box">
                                                                <h4>{{$c->title}}</h4>
                                                                <p class="slide-text">{{$c->description}}</p>
                                                            </div>
                                                        </a>
                                                        @endforeach
                                                    </div>
							...
							<ul class="menu" role="tablist">
								...
								<li class="MoreLikeThis current" id="tab-MoreLikeThis">
