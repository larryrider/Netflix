    ...
    <div id="appMountPoint">
        <div lang="es-ES" dir="ltr" class="lang_es">
            <div class="bd dark-background has-uma lang_es" lang="es-ES">
                <div class="pinning-header">
                    <div class="pinning-header-container">
                        ...
                        <ul class="tabbed-primary-navigation" role="navigation">
                            <li class="navigation-menu" id="navigationMenu">
                                ...
                                <div class="sub-menu theme-lakira" style="opacity:0;display:none;" id="navOculto">
                                    ...
                                    <ul class="sub-menu-list">
                                        ...
                                        <li class="sub-menu-item"><a class="current active" href="/series">Series</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="navigation-tab">
                                <a class="current active" href="/series">Series</a>
                            </li>
                        </ul>
                            ...
                            <div class="sub-header-wrapper">
                                <div class="aro-gallery-header">
                                    ...
                                    <div class="aro-genre-details">
                                        <span class="genreTitle">Series</span>
                                        <div class="subgenres">
                                            <div label="Géneros" cols="3" class="nfDropDown theme-lakira">
                                                <div id="btnGeneros" class="label" role="button" tabindex="0" aria-haspopup="true" aria-expanded="true">
                                                    Géneros<span class="arrow"></span>
                                                </div>
                                                <div id="menuGeneros" class="sub-menu theme-lakira" style="opacity: 1; transition-duration: 150ms; display: none;">
                                                <ul class="sub-menu-list multi-column">
                                                    @foreach($categories as $c)
                                                        <li class="sub-menu-item"><a class="sub-menu-link" href="/series/cat/{{$c->id}}">{{$c->category}}</a></li>
                                                    @endforeach
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="aro-toggle">
                                            <div class="aro-row-toggle" aria-label="Vista de lista">
                                                <svg class="svg-icon svg-icon-rows" focusable="true">
                                                    <use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#rows"></use>
                                                </svg>
                                                </div>
                                                <div class="aro-grid-toggle">
                                                <div aria-label="Vista de cuadrícula">
                                                    <svg class="svg-icon svg-icon-grid" focusable="true">
                                                        <use filter="" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#grid"></use>
                                                    </svg>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="mainView" role="main" style="margin-top: 50px;">
    ...
    <script>
        (function() {
            ...
            $("#btnGeneros").click(function(){
                if($("#menuGeneros").css('display') == 'block'){
                    $("#menuGeneros").css('display', 'none');
                }else{
                    $("#menuGeneros").css('display', 'block');
                }
